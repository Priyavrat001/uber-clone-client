...
const SelectCar = ({ vehiclePanelOpen, setVehiclePanelOpen, setConfirmVehicel, fares, duration, setVechicleType }) => {
  return (
    <>
      {
        vehiclePanelOpen && (
          <div className='fixed z-0 bottom-0 bg-white w-full p-3 translate-y-0'>
            ...
            <div onClick={() => {
              ...
              <div className='w-1/2'>
                ...
                <h5 className='font-medium text-sm'>{duration}  mins away</h5>
            ...
            <div onClick={() => {
              ...
              <h2 className='text-2xl font-semibold'>₹{fares?.auto}</h2>
            </div>
          </div>
        )
      }
